...
<script>
	...
	function mostrarDatos(idEntidad,idTr){
		...
		$('#divModificacion').load('../../tipoAnimal.do?metodo=cargarTipoAnimalAModificar&id=' + idEntidad);
...
<table border="0" class="cuadrado" align="center" width="80%"
	...
	<tr>
		<td class="azulAjustado">
			<bean:message key='SIIG.titulo.ModificacionTipoAnimal'/>
		</td>
	</tr>
	<tr>
		<td height="20"></td>
	...
	<tr>
		...
		<table border="0" class="cuadrado" align="center" width="90%"
			...
			<tr>
				...
				<td class="azulAjustado"><bean:message key='SIIG.label.Categoria'/></td>
				<td class="azulAjustado"><bean:message key='SIIG.label.Valor'/></td>
				<td class="azulAjustado"></td>
			</tr>
			<%String clase=""; %>
			<c:forEach items="${tipoAnimales}" var="tipoAnimal" varStatus="i">
				<%clase=(clase.equals("")?"par":""); %>
				<tr id="tr${i.count}" class="botonerab <%=clase%>">
					<td><c:out value="${tipoAnimal.descripcion}" /></td>
					<td><c:out value="${tipoAnimal.descripcionCategoria}" /></td>
					<td><c:out value="${tipoAnimal.valor}" /></td>
					<td>
						<a href="javascript:mostrarDatos(${tipoAnimal.id},${i.count});">
