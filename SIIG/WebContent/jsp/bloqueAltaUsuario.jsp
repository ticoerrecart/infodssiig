...
<html:form action="usuario" styleId="usuarioFormId">
	...
	<table border="0" class="cuadrado" align="center" width="60%" cellpadding="2">
		...
		<tr>
			<td class="botoneralNegritaRight"><bean:message key='SIIG.label.Contrasenia'/></td>
			<td  align="left">
		...
		<tr>
			<td class="botoneralNegritaRight">
				<bean:message key='SIIG.label.ConfirmarContrasenia'/>
			</td>
			<td  align="left">
		...
		<tr>
			<c:choose>
				<c:when test="${metodo=='altaUsuario'}"><!-- ALTA -->
					<td class="botoneralNegritaRight"><bean:message key='SIIG.label.Habilitado'/></td>
					<td align="left">
		...
		<tr>
			<td class="botoneralNegritaRight"><bean:message key='SIIG.label.Rol'/></td>
			<td align="left">
