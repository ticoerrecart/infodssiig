...
<table border="0" class="cuadrado" align="center" width="80%"
	...
	<tr>
		<td class="azulAjustado">
			<bean:message key='SIIG.titulo.ModificacionEntidad'/>
		</td>
	</tr>
	<tr>
		<td height="20"></td>
	...
	<tr>
		...
		<table border="0" class="cuadrado" align="center" width="90%"
			...
			<tr>
				...
				<td class="azulAjustado"><bean:message key='SIIG.label.Direccion'/></td>
				<td class="azulAjustado"><bean:message key='SIIG.label.Localidad'/></td>
				<td class="azulAjustado"><bean:message key='SIIG.label.Telefono'/></td>
				<td class="azulAjustado"><bean:message key='SIIG.label.EMail'/></td>
				<td class="azulAjustado"><bean:message key='SIIG.label.TipoDeProductor'/></td>
