...
<table border="0" class="cuadrado" align="center" width="60%" cellpadding="2">
	<tr>
		<td class="azulAjustado">
			<bean:message key='SIIG.titulo.ModificacionTipoProducto'/>		
		</td>
	</tr>
	<tr>
		<td height="20"></td>
	...
	<tr>
		...
		<table id="idTipoProducto" border="0" class="cuadrado" align="center"
			...
			<tr>
				<td class="azulAjustado"><bean:message key='SIIG.label.TipoDeProducto'/></td>
				<td class="azulAjustado"><bean:message key='SIIG.label.RegaliaMinera'/></td>
