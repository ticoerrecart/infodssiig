...
<html:form action="entidad" styleId="entidadFormId">
	...
	<table border="0" class="cuadrado" align="center" width="60%"
		...
		<tr>
			<td width="45%" class="botoneralNegritaRight"><bean:message key='SIIG.label.TipoDeProductor'/></td>
		...
		<tr>
			<td class="botoneralNegritaRight"><bean:message key='SIIG.label.Nombre'/></td>
			<td align="left"><html:text property="entidadDTO.nombre" size="30"
				styleClass="botonerab" value="${entidad.nombre}" /></td>
		</tr>
		<tr>
			<td class="botoneralNegritaRight"><bean:message key='SIIG.label.Localidad'/></td>
			<td align="left">
		...
		<tr class="matriculaCuitCP">
			<td class="botoneralNegritaRight"><bean:message key='SIIG.label.CodigoPostal'/></td>
