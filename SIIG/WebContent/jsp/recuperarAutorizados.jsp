...
<script>
	...
	function mostrarDatos(idEntidad,idTr){
		...
		$('#divModificacion').load('../../autorizado.do?metodo=cargarAutorizadoAModificar&id=' + idEntidad);
...
<table border="0" class="cuadrado" align="center" width="80%"
	...
	<tr>
		<td class="azulAjustado">
			<bean:message key='SIIG.titulo.ModificacionAutorizado'/>
		</td>
	</tr>
	<tr>
		<td height="20"></td>
	...
	<tr>
		...
		<table border="0" class="cuadrado" align="center" width="90%"
			...
			<tr>
				...
				<td class="azulAjustado"><bean:message key='SIIG.label.Dni'/></td>
			...
			<c:forEach items="${autorizados}" var="autorizado" varStatus="i">
				...
				<tr id="tr${i.count}" class="botonerab <%=clase%>">
					<td><c:out value="${autorizado.nombre}" /></td>
					<td><c:out value="${autorizado.dni}" /></td>
					<td>
						<a href="javascript:mostrarDatos(${autorizado.id},${i.count});">
