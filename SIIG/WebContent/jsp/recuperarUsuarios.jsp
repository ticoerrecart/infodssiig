...
<table border="0" class="cuadrado" align="center" width="80%"
	cellpadding="2">
	<tr>
		<td class="azulAjustado"><bean:message key='SIIG.titulo.ModificacionUsuario'/></td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
		...
		<td>
			<table border="0" class="cuadrado" align="center" width="60%" cellpadding="2">
				<tr>
					...
					<td class="azulAjustado"><bean:message key='SIIG.label.Rol'/></td>
					<td class="azulAjustado"><bean:message key='SIIG.label.Entidad'/></td>
